...
<html>
  ...
  <script language="javascript">
		function checkEmpty(addHardWare)
		{		
	...
	<center>
	<h1>
		 Register hardware(带<font color="red">*</font>为必填项)
	</h1>
</center>
	...
	face="楷体_GB2312" color="#FF0000"><s:fielderror /> </font> </I>  读取显示提示信息 -->
		<!-- 防止重复提交 -->
	<form name="addHardWare" action="addHardWare" method="post" onsubmit="return checkEmpty(this)">
		...
		<table align="center">
				...
				<tr>
					...
					<td>
						<input type="text" name="assetTypeName" style="background-color:#808080" value="硬件" readonly="readonly"/>
					</td>
				</tr>
				<tr>
					<td>

...
<html>
 ...
 var email_Flag = false;
	...
	face="楷体_GB2312" color="#FF0000"><s:fielderror /> </font> </I>  读取显示提示信息 -->
		<!-- 防止重复提交 -->
	<form action="modifyFixedAssets" method="post">

		<table align="center">
				<tr>
					
					<td>
						<input type="hidden" name="vinasset.id" value="${vinasset.id}"/>
						设备编码:
					</td>
					<td>
						<input type="text" name="vinasset.dataBasic.devCode" readonly="readonly" style="background-color:#808080" value="${vinasset.dataBasic.devCode}"/>
					</td>
				</tr>
				<tr>
					<td>
					...
					<td>
						<input type="text" name="vinasset.vinDate" value="${vinasset.vinDate}" onFocus="calendar()"/>
					</td>
				</tr>
				<tr>
					<td>
					...
					<td>
						<input type="text" name="vinasset.vinCost" value="${vinasset.vinCost}"/>
					</td>
				</tr>

...
<body>
<form name="form1" method="post" action="addHardWare">
  <table width="1052" border=0 align=center cellpadding=2 cellspacing=1 bordercolor="#799AE1" class=tableBorder>
    <tbody>
      <tr>
        <th align=center colspan=16 style="height: 23px">硬件结果显示</th>
      </tr>
      <tr bgcolor="#DEE5FA">
   ...
   <s:iterator value="#session.dataBasicList">
      <tr align="center" bgcolor="#799AE1">
        ...
        <td width="9%" align="center" class=txlHeaderBackgroundAlternate>硬件</td>
        ...
        <td width="6%" align="center" class=txlHeaderBackgroundAlternate><s:property value="assetSmallType.smalltypename"/></td>
         <%
           if(!session.getAttribute("roleId").equals(1)&&!session.getAttribute("roleId").equals(4)){
        %> 
        <td width="6%" align="center" class=txlHeaderBackgroundAlternate><a href="modifyHardWarePre?devCode=<s:property value="devCode"/>">修改</a></td>
        <td width="6%" align="center" class=txlHeaderBackgroundAlternate><a href="deleteHardWare?devCode=<s:property value="devCode"/>" onclick="javascript:return confirm('确定删除吗?');">删除</a></td>
      <%} %>
      </tr>
       </s:iterator>
 </BODY>
